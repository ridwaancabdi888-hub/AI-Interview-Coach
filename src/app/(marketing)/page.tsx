  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="pricing" className="py-24"><div className="container text-center"><h2 className="text-4xl font-extrabold">Start building confidence today.</h2><p className="mx-auto mt-4 max-w-xl text-slate-600">Create your free account and complete your first personalized mock interview.</p><Link href="/sign-up" className="btn btn-primary mt-8">Create free account</Link></div></section>
      </main>
